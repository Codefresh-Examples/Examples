# Canary Release Pattern Example with Codefresh and K8S
...
Again - the flow here can be as complex or as simple as your specific environment requires.
...
Application code is all in our example should reside in the file named api.py. This is what gets packaged inside the app Docker image.
